...
if(isset($_POST['update_profile']))
{
    ...
    $select = mysqli_query($conn, "SELECT * FROM users WHERE MAIL = '$user_id'") or die('query failed');
    ...
    mysqli_query($conn, "UPDATE users SET F_name = '$update_name1', L_name = '$update_name2', MAIL = '$update_email' WHERE MAIL = '$user_id'") or die('query failed');
    ...
    if(!empty($update_pass) || !empty($new_pass) || !empty($confirm_pass))
    {
        ...
        {
            mysqli_query($conn, "UPDATE users SET PASSWORD = '$confirm_pass' WHERE MAIL = '$user_id'") or die('query failed');
